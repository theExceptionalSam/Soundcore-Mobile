(function(){
  ...
  /* ── Light / dark theme toggle (present on every page) ──
     The initial theme is applied instantly by a tiny inline script
     in <head> (avoids a flash of the wrong theme); this just wires
     up the toggle button(s) and keeps the preference in sync. */
